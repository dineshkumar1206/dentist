...
const benefits = [
  ...
  { icon: Sparkles, text: "Prevents acute local infections, swelling conditions, and painful gum disease" },
        ...
        <div className="max-w-6xl mx-auto grid md:grid-cols-2 gap-12 items-center relative z-10">
          ...
          >
            ...
            >
              <img
                src={heroImg}
                alt="Surgical Removal of Wisdom Teeth specialty setup"
        ...
        <div className="grid md:grid-cols-2 gap-14 items-center">
          ...
          <AnimatedSection delay={0.1}>
            ...
            <ul className="grid grid-cols-2 gap-x-4 gap-y-2 text-sm text-slate-600 font-medium mb-6">
              <li className="flex items-center gap-2"><span className="text-[#682187]">❌</span> Severe throbbing pain in back-jaw zones</li>
              <li className="flex items-center gap-2"><span className="text-[#682187]">❌</span> Impacted teeth completely locked in bone</li>
              <li className="flex items-center gap-2"><span className="text-[#682187]">❌</span> Localized swelling, redness, or infection</li>
              <li className="flex items-center gap-2"><span className="text-[#682187]">❌</span> Friction damage to neighboring molars</li>
              <li className="flex items-center gap-2"><span className="text-[#682187]">❌</span> Strict difficulty chewing or opening jaws</li>
              <li className="flex items-center gap-2"><span className="text-[#682187]">❌</span> Recurring pericoronitis gum outbreaks</li>
            </ul>
            ...
            <div className="relative">
              ...
              >
                ...
                <div>
                  ...
                  <p className="text-xs text-slate-400">Post-operative support included</p>
                </div>
              </motion.div>
            </div>
          </AnimatedSection>
