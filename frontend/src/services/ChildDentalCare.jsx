...
// ─── Data ─────────────────────────────────────────────────────────────────────
const benefits = [
  { icon: Smile, text: "Routine dental examinations and cleanings" },
  { icon: HeartPulse, text: "Dental sealants to protect teeth" },
  { icon: Shield, text: "Tooth-colored fillings for cavities" },
  { icon: Bone, text: "Monitoring of tooth and jaw development" },
  { icon: CheckCircle2, text: "Emergency dental care for children" },
  { icon: Star, text: "Guidance on proper brushing and flossing techniques" },
];

const steps = [
  {
    num: "01",
    title: "Gentle First Assessment",
    desc: "A fun, stress-free comprehensive examination with ultra-low radiation digital imaging to map your child's growth.",
    icon: Microscope,
  },
  {
    num: "02",
    title: "Protective Care & Treatment",
    desc: "Cavity prevention, premium sealants, or gentle treatments are applied comfortably using child-friendly techniques.",
    icon: Shield,
  },
  {
    num: "03",
    title: "Monitoring & Development",
    desc: "Regular tracking of jaw growth and permanent tooth eruption to ensure natural alignment over time.",
    icon: Clock,
  },
  {
    num: "04",
    title: "A Lifetime Healthy Smile",
    desc: "Customised home-care education and bright, healthy teeth that build your child's confidence for the future.",
    icon: Smile,
  },
];
...
const stats = [
  ...
  { value: "16+ Yrs", label: "Pediatric Experience" },
  { value: "10k+", label: "Happy Little Smiles" },
  { value: "4.9★", label: "Parent Rating" },
];

const heroImg = "/images/child-dental.png";
const procedureImg = "/images/Importance.png";
      ...
      <section className="relative overflow-hidden bg-gradient-to-br from-[#f5f2f8] via-[#fcfbfe] to-white pt-24 pb-20 px-6 md:px-16">
        ...
        <div className="max-w-6xl mx-auto grid md:grid-cols-2 gap-12 items-center relative z-10">
          <div>
            ...
            >
              Child dental care is essential for maintaining healthy teeth and
              gums from an early age. Our pediatric dental services focus on
              preventing dental problems, promoting good oral hygiene habits,
              and ensuring a positive dental experience for children.
            </motion.p>

            {/* Micro Interaction Action Block Elements */}
            <motion.div
              custom={2}
              variants={fadeUp}
              initial="hidden"
          ...
          >
            ...
            >
              <img
                src={heroImg}
                alt="Child dental care specialty setup"
        ...
        <div className="grid md:grid-cols-2 gap-14 items-center">
          ...
          <AnimatedSection>
            <div className="relative">
              ...
              >
                <img
                  src={procedureImg}
                  alt="Importance of pediatric checkups"
          ...
          <AnimatedSection delay={0.1}>
            ...
            <p className="text-slate-500 font-light leading-relaxed mb-5">
              Regular dental check-ups during childhood play a vital role in
              preventing cavities, monitoring tooth development, and detecting
              oral health issues early.
            </p>
            <p className="text-slate-500 font-light leading-relaxed">
              Our experienced dental team creates a welcoming and comfortable
              environment where children feel safe and relaxed.
            </p>
            <div className="mt-8 flex items-center gap-4 bg-[#fdfbfe] border border-purple-100 rounded-xl p-4 shadow-sm">
              ...
              <p className="text-sm text-slate-600 font-medium">
                <strong className="text-[#1a2332]">100% BPA-Free Materials</strong>{" "}
                — we use only premium, non-toxic, and certified pediatric composites.
              </p>
            </div>
          </AnimatedSection>
        </div>
        ...
        <div className="max-w-6xl mx-auto">
          <AnimatedSection className="text-center mb-14">
            ...
            <p className="text-slate-400 max-w-xl mx-auto font-light text-sm">
              ...
              specifically for children, including:
            </p>
          </AnimatedSection>
        ...
        <div className="max-w-6xl mx-auto grid md:grid-cols-2 gap-14 items-center">
          <AnimatedSection delay={0.1}>
            ...
            <p className="text-slate-500 font-light leading-relaxed mb-6">
              We understand the unique dental needs of children and are
              committed to providing high-quality pediatric dental care.
            </p>
            {[
              "Board-certified pediatric dental specialists",
              "Premium-grade, biocompatible, and BPA-free materials",
              "Ultra-low radiation 3D imaging and growth tracking",
              "Compassionate, anxiety-free care from first visit to aftercare",
            ].map((pt, i) => (
              <motion.div
                key={pt}
                custom={i}
          ...
          <AnimatedSection>
            <div className="relative">
              ...
              >
                <img
                  src={smileImg}
                  alt="Happy child after dental care treatment"
          ...
          <div className="relative bg-gradient-to-br from-[#682187] to-[#4c1263] rounded-3xl overflow-hidden px-10 py-14 text-center shadow-2xl shadow-purple-900/20">
            ...
            <div className="relative z-10">
              ...
              <p className="text-white/85 max-w-xl mx-auto mb-8 text-base font-light leading-relaxed">
                ...
                team is ready to provide gentle, expert care from the very
                first visit.
              </p>
