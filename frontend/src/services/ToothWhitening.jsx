        ...
        <div className="max-w-6xl mx-auto grid md:grid-cols-2 gap-12 items-center relative z-10">
          <div>
            ...
            >
              ...
              <span className="text-[#0ea5e9]">Professional Tooth Whitening</span>
            </motion.h1>
        ...
        <div className="grid md:grid-cols-2 gap-14 items-center">
          ...
          <AnimatedSection delay={0.1}>
            ...
            <h2 className="text-3xl md:text-4xl font-extrabold mt-2 mb-4 leading-tight">
              What Causes <span className="text-[#0ea5e9]">Tooth Staining?</span>
            </h2>
      ...
      <section className="py-20 px-6 md:px-16 max-w-6xl mx-auto">
        <AnimatedSection className="text-center mb-14">
          ...
          <h2 className="text-3xl md:text-4xl font-extrabold mt-2 leading-tight">
            Our Whitening <span className="text-[#0ea5e9]">Process</span>
          </h2>
      ...
      <section className="bg-[#f0f7ff] py-20 px-6 md:px-16">
        <div className="max-w-6xl mx-auto grid md:grid-cols-2 gap-14 items-center">
          <AnimatedSection delay={0.1}>
            ...
            <h2 className="text-3xl md:text-4xl font-extrabold mt-2 mb-4 leading-tight">
              Maintain Your <span className="text-[#0ea5e9]">Brilliant New Smile</span>
            </h2>
            <div className="h-1 w-12 bg-[#0ea5e9] rounded-full mb-6" />
