...
// ─── Unsplash image URLs (dental / implant themed, no auth required) ──────────
const heroImg =
  "/images/Dental-implants.png";
const procedureImg =
  "/images/tooth-implant.png";
const smileImg =
      ...
      <section className="relative overflow-hidden bg-gradient-to-br from-[#f0f7ff] via-[#e0f2fe] to-[#f0f7ff] pt-24 pb-20 px-6 md:px-16">
        ...
        <div className="max-w-6xl mx-auto grid md:grid-cols-2 gap-12 items-center relative z-10">
          ...
          <div>
            ...
            >
              <button className="inline-flex items-center gap-2 bg-[#0ea5e9] hover:bg-[#0284c7] text-white font-semibold px-7 py-3.5 rounded-full shadow-lg shadow-[#0ea5e9]/30 transition-all duration-200 hover:scale-105 active:scale-95">
          ...
          >
            ...
            {/* <motion.div
              ...
              className="absolute -bottom-5 -left-5 bg-white rounded-xl shadow-xl px-5 py-3.5 flex items-center gap-3 border border-gray-100"
            >
              ...
              <div>
                <p className="font-bold text-[#1a2332] text-sm leading-none">4.9 / 5.0</p>
                <p className="text-[10px] text-gray-400 mt-0.5">500+ patient reviews</p>
              </div>
            </motion.div> */}
            {/* corner tag */}
            <motion.div
